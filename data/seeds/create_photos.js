  ...
  return knex('photos').del()
    .then(function () {
      ...
      return knex('photos').insert([
        ...
        {trip_id: 1, user_id: 1, img_caption: 'the trevi fountain', img_url: 'https://images.unsplash.com/photo-1529154036614-a60975f5c760?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1355&q=80'},
